...
collects from users of the Python Package Index ("PyPI"),
...
-   Datadog to aggregate metrics and application performance data. Some personal information may be stored on their servers. Their use of this information is subject to the [Data Processing Addendum](https://www.datadoghq.com/legal/data-processing-addendum/) between Datadog and PSF and the [Datadog Privacy Policy](https://www.datadoghq.com/legal/privacy/).
...
-   To provide you with information about activities relevant to you on PyPI
